...
def parse_args():
    ...
    parser.add("--vqvae_upper_path", default="", type=str)
    parser.add("--vqvae_hands_path", default="", type=str)
    parser.add("--vqvae_lower_path", default="", type=str)
    ...
    # --------------- data ---------------------------- #
    parser.add("--use_amass", default=False, type=str2bool)
...
#    parser.add("--gan_noise_size", default=0, type=int)
    ...
    # --------------- vqvae -------------------------- #
    parser.add("--levels", default=1, type=int)
    parser.add("--downs_t", default=[3] ,type=int, nargs="*")
    parser.add("--strides_t", default=[2], type=int,nargs="*")
    parser.add("--emb_width", default=512, type=int)
    parser.add("--l_bins", default=512, type=int)
    parser.add("--l_mu", default=0.99, type=float)
    parser.add("--commit", default=0.02, type=float)
    parser.add("--hvqvae_multipliers", default=[1], type=int,nargs="*")
    parser.add("--width", default=512, type=int)
    parser.add("--depth", default=3, type=int)
    parser.add("--m_conv", default=1.0, type=float)
    parser.add("--dilation_growth_rate", default=3, type=int)
    parser.add("--sample_length", default=34, type=int)
    parser.add("--use_bottleneck", default=True, type=str2bool)
    parser.add("--joint_channel", default=3, type=int)
    parser.add("--vel", default=1, type=int)
    parser.add("--acc", default=1, type=int)
